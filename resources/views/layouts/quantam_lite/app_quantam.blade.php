...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="shortcut icon" href="{{ asset('templates/quantam-lite/assets/images/favicon.png') }}" type="image/x-icon">
    <link rel="icon" href="{{ asset('templates/quantam-lite/assets/images/favicon.ico') }}" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('templates/quantam-lite/assets/icon/themify-icons/themify-icons.css') }}">

    <!-- iconfont -->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('templates/quantam-lite/assets/icon/icofont/css/icofont.css') }}">

    <!-- simple line icon -->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('templates/quantam-lite/assets/icon/simple-line-icons/css/simple-line-icons.css') }}">

    <!-- Required Fremwork -->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('templates/quantam-lite/assets/plugins/bootstrap/css/bootstrap.min.css') }}">

    <!-- Chartlist chart css -->
    <link rel="stylesheet" href="{{ asset('templates/quantam-lite/assets/plugins/chartist/dist/chartist.css') }}"
        type="text/css" media="all">

    <!-- Weather css -->
    <link href="{{ asset('templates/quantam-lite/assets/css/svg-weather.css') }}" rel="stylesheet">


    <!-- Style.css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('templates/quantam-lite/assets/css/main.css') }}">

    <!-- Responsive.css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('templates/quantam-lite/assets/css/responsive.css') }}">
...
<body class="sidebar-mini fixed">
    ...
    <div class="wrapper">
        ...
        <header class="main-header-top hidden-print">
            <a href="index.html" class="logo"><img class="img-fluid able-logo"
                    src="{{ asset('templates/quantam-lite/assets/images/logo.png') }}" alt="Theme-logo"></a>
                            ...
                            <ul class="dropdown-menu">
                                    ...
                                    <a href="javascript:;" class="media">
                                        <span class="media-left media-icon">
                                            <img class="img-circle"
                                                src="{{ asset('templates/quantam-lite/assets/images/avatar-1.png') }}"
                                                alt="User Image">
                                        </span>
                                ...
                                <li class="bell-notification">
                                    <a href="javascript:;" class="media">
                                        <span class="media-left media-icon">
                                            <img class="img-circle"
                                                src="{{ asset('templates/quantam-lite/assets/images/avatar-2.png') }}"
                                                alt="User Image">
                                        </span>
                                ...
                                <li class="bell-notification">
                                    <a href="javascript:;" class="media"><span class="media-left media-icon">
                                            <img class="img-circle"
                                                src="{{ asset('templates/quantam-lite/assets/images/avatar-3.png') }}"
                                                alt="User Image">
                                        </span>
                    ...
                    <div id="morphsearch" class="morphsearch">
                        ...
                        <div class="morphsearch-content">
                            ...
                            <div class="dummy-column">
                                <h2>Popular</h2>
                                <a class="dummy-media-object" href="#!">
                                    <img src="{{ asset('templates/quantam-lite/assets/images/avatar-1.png') }}"
                    ...
                    <div class="card-content user-box">
                        ...
                        <div class="main-friend-list">
                            ...
                            <div class="media friendlist-box" data-id="5" data-status="online"
                                ...
                                <a class="media-left" href="#!">
                                    <img class="media-object img-circle"
                                        src="{{ asset('templates/quantam-lite/assets/images/avatar-4.png') }}"
                                        alt="Generic placeholder image">
                                    <div class="live-status bg-success"></div>
                                </a>
                                <div class="media-body">
                            ...
                            <div class="media friendlist-box" data-id="6" data-status="offline"
                                ...
                                <a class="media-left" href="#!">
                                    <img class="media-object img-circle"
                                        src="{{ asset('templates/quantam-lite/assets/images/avatar-5.png') }}"
                                        alt="Generic placeholder image">
                                    <div class="live-status bg-danger"></div>
                                </a>
                                <div class="media-body">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="user-block-2">
                                <img class="img-fluid"
                                    src="{{ asset('templates/quantam-lite/assets/images/widget/user-1.png') }}"
                                    alt="user-header">
                    ...
                    <div class="col-xl-4 col-lg-12 grid-item">
                        <div class="card">
                            <div class="card-block horizontal-card-img d-flex">
                                <img class="media-object img-circle"
                                    src="{{ asset('templates/quantam-lite/assets/images/lockscreen.png') }}"
                                    alt="Generic placeholder image">
                                <div class="d-inlineblock  p-l-20">
                                    <h6>Josephin Doe</h6>
                                    <a href="#">contact@admin.com</a>
    ...
    <!-- Required Jqurey -->
    <script src="{{ asset('templates/quantam-lite/assets/plugins/Jquery/dist/jquery.min.js') }}"></script>
    <script src="{{ asset('templates/quantam-lite/assets/plugins/jquery-ui/jquery-ui.min.js') }}"></script>
    <script src="{{ asset('templates/quantam-lite/assets/plugins/tether/dist/js/tether.min.js') }}"></script>

    <!-- Required Fremwork -->
    <script src="{{ asset('templates/quantam-lite/assets/plugins/bootstrap/js/bootstrap.min.js') }}"></script>

    <!-- Scrollbar JS-->
    <script src="{{ asset('templates/quantam-lite/assets/plugins/jquery-slimscroll/jquery.slimscroll.js') }}"></script>
    <script src="{{ asset('templates/quantam-lite/assets/plugins/jquery.nicescroll/jquery.nicescroll.min.js') }}"></script>

    <!--classic JS-->
    <script src="{{ asset('templates/quantam-lite/assets/plugins/classie/classie.js') }}"></script>

    <!-- notification -->
    <script src="{{ asset('templates/quantam-lite/assets/plugins/notification/js/bootstrap-growl.min.js') }}"></script>

    <!-- Sparkline charts -->
    <script src="{{ asset('templates/quantam-lite/assets/plugins/jquery-sparkline/dist/jquery.sparkline.js') }}"></script>

    <!-- Counter js  -->
    <script src="{{ asset('templates/quantam-lite/assets/plugins/waypoints/jquery.waypoints.min.js') }}"></script>
    <script src="{{ asset('templates/quantam-lite/assets/plugins/countdown/js/jquery.counterup.js') }}"></script>

    <!-- Echart js -->
    <script src="{{ asset('templates/quantam-lite/assets/plugins/charts/echarts/js/echarts-all.js') }}"></script>
    ...
    <!-- custom js -->
    <script type="text/javascript" src="{{ asset('templates/quantam-lite/assets/js/main.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('templates/quantam-lite/assets/pages/dashboard.js') }}"></script>
    <script type="text/javascript" src="{{ asset('templates/quantam-lite/assets/pages/elements.js') }}"></script>
    <script src="{{ asset('templates/quantam-lite/assets/js/menu.min.js') }}"></script>
    <script>
        var $window = $(window);
