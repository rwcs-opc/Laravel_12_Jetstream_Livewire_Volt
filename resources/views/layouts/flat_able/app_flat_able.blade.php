...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="{{ asset('templates/flat-able-lite/dist/assets/images/favicon.ico') }}"
        type="image/x-icon">

    <!-- vendor css -->
    <link rel="stylesheet" href="{{ asset('templates/flat-able-lite/dist/assets/css/style.css') }}">
...
<body class="">
                ...
                <div class="">
                    <div class="main-menu-header">
                        <img class="img-radius"
                            src="{{ asset('templates/flat-able-lite/dist/assets/images/user/avatar-2.jpg') }}"
    ...
    <header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
        ...
        <div class="m-header">
            ...
            <a href="#!" class="b-brand">
                ...
                <img src="{{ asset('templates/flat-able-lite/dist/assets/images/logo.png') }}" alt=""
                    class="logo">
                <img src="{{ asset('templates/flat-able-lite/dist/assets/images/logo-icon.png') }}" alt=""
                    class="logo-thumb">
            </a>
                        ...
                        <div class="dropdown-menu dropdown-menu-right notification">
                            ...
                            <ul class="noti-body">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius"
                                            src="{{ asset('templates/flat-able-lite/dist/assets/images/user/avatar-1.jpg') }}"
                ...
                <li>
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                <img src="{{ asset('templates/flat-able-lite/dist/assets/images/user/avatar-1.jpg') }}"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                ...
                                                <div class="d-inline-block align-middle">
                                                    <img src="{{ asset('templates/flat-able-lite/dist/assets/images/user/avatar-4.jpg') }}"
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="d-inline-block align-middle">
                                                    <img src="{{ asset('templates/flat-able-lite/dist/assets/images/user/avatar-2.jpg') }}"
                                                        alt="user image" class="img-radius wid-40 align-top m-r-15">
                                                    <div class="d-inline-block">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="d-inline-block align-middle">
                                                    <img src="{{ asset('templates/flat-able-lite/dist/assets/images/user/avatar-3.jpg') }}"
                                                        alt="user image" class="img-radius wid-40 align-top m-r-15">
                                                    <div class="d-inline-block">
                                                        <h6>William Jem</h6>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row m-b-20 received-chat">
                                ...
                                <div class="col">
                                    <div class="msg">
                                        <p class="m-b-0">Nice to meet you!</p>
                                        <img src="{{ asset('templates/flat-able-lite/dist/assets/images/widget/dashborad-1.jpg') }}"
                                            alt="">
                                        <img src="{{ asset('templates/flat-able-lite/dist/assets/images/widget/dashborad-3.jpg') }}"
                                            alt="">
                                    </div>
                                    <p class="text-muted m-b-0"><i class="fa fa-clock-o m-r-10"></i>10:20am</p>
                                </div>
    ...
    <!-- Required Js -->
    <script src="{{ asset('templates/flat-able-lite/dist/assets/js/vendor-all.min.js') }}"></script>
    <script src="{{ asset('templates/flat-able-lite/dist/assets/js/plugins/bootstrap.min.js') }}"></script>
    <script src="{{ asset('templates/flat-able-lite/dist/assets/js/pcoded.min.js') }}"></script>

    <!-- Apex Chart -->
    <script src="{{ asset('templates/flat-able-lite/dist/assets/js/plugins/apexcharts.min.js') }}"></script>


    <!-- custom-chart js -->
    <script src="{{ asset('templates/flat-able-lite/dist/assets/js/pages/dashboard-main.js') }}"></script>
</body>
