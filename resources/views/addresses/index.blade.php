                        ...
                        @forelse ($addresses as $address)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('addresses.show', $address->id) }}" class="btn btn-sm btn-outline-info me-1">View</a>
                                    <a href="{{ route('addresses.edit', $address->id) }}" class="btn btn-sm btn-outline-warning me-1">Edit</a>
